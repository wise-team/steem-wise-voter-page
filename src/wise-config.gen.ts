...
export const data = {
  ...
  "get_block": true,
    ...
    "docker": {
      ...
      "labels": {
        "domain": "vote.wise",
        "defaultLabels": [ () => "maintainer=\"The Wise Team (https://wise-team.io/) <contact@wiseteam.io>\"", () => "vote.wise.wise-version=\"3.0.6-rc2\"", () => "vote.wise.license=\"MIT\"", () => "vote.wise.repository=\"steem-wise-voter-page\"" ],
      },
